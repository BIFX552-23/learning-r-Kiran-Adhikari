...
First command results in a numeric vector.

The second results in a character vector.

The third command results in character vector, because it includes character values.
