...
{
  print('there are observation from 2012')
}
```
...
for (i in levels(gapminder$continent))
{
 ...
 if(mean_lifeExp >=50)
 {
  paste (i, 'has a mean life expenctancy greater than 50 years') %>%
     print()
 }else{
     paste(i , 'has a mean life expenctancy less than 50 years') %>%
      print()
   }
}
```
...
for (i in levels(gapminder$country))
{
 ...
 if(mean_lifeExp < 50)
 {
  paste (i, 'has a mean life expenctancy less than 50 years') %>%
     ...
     paste(i , 'has a mean life expenctancy between 50 and 70 years') %>%
      print()
 }else{
    paste (i, 'has a mean life expenctancy greater than 70 years') %>%
     print() 
   }
}
```
